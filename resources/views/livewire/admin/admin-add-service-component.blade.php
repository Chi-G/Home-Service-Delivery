                                ...
                                <div class="panel body">                                    
                                    ...
                                    <form class="form-horizontal" wire:submit.prevent="createService">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-group" wire:model="service_category_id">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9" wire:model="description">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="file" class="form-control-file" name="thumbanail" wire:model="thumbnail">
