                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <aside>
                                <h4>The Office</h4>
                                <address>
                                    <strong>Chiji Media Home Services.</strong><br>
                                    <i class="fa fa-map-marker"></i><strong>Address: </strong>Umuahia, Abia state,
                                    Nigeria<br>
                                    <i class="fa fa-phone"></i><strong>Phone: </strong> +234-7065910449
                                </address>
                                <address>
                                    <strong>Chiji Media Emails</strong><br>
                                    <i class="fa fa-envelope"></i><strong>Email:</strong><a
                                        href="mailto:chijindu.nwokeohuru@gmail.com"> chijindu.nwokeohuru@gmail.com</a><br>
                                    <i class="fa fa-envelope"></i><strong>Email:</strong><a
                                        href="mailto:chijindu.nwokeohuru@gmail.com"> chijindu.nwokeohuru@gmail.com</a>
                                </address>
                            </aside>
                            <hr class="tall">
                        </div>
