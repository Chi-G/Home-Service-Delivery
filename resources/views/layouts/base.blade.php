                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            <li><a href="tel:+234-7065910449"><i class="fa fa-phone"></i> +234-7065910449</a></li>
                            <li><a href="mailto:chijindu.nwokeohuru@gmail.com"><i class="fa fa-envelope"></i>
                                    chijindu.nwokeohuru@gmail.com</a></li>
                        </ul>
                        <ul class="visible-xs visible-sm">
                            <li class="text-left"><a href="+234-7065910449"><i class="fa fa-phone"></i>
                                +234-7065910449</a></li>
                            <li class="text-right"><a href="index.php/changelocation.html"><i
                                        class="fa fa-map-marker"></i> Chiji Home Services Delivery</a></li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-right">
                            <li><i class="fa fa-comment"></i> Live Chat</li>
                            <li><a href="index.php/changelocation.html"><i class="fa fa-map-marker"></i>Chiji Home Services Delivery</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    @if(Route::has('login'))
                        @auth
                            @if (Auth::user()->utype === 'ADM')
                                <li class="login-form"> <a href="#" title="Register">Hi, {{ Auth::user()->name }} (Admin)</a>
                                    <ul class="drop-down one-column hover-fade">
                            ...
                            @elseif (Auth::user()->utype === 'SVP')
                                <li class="login-form"> <a href="#" title="Register">Hi, {{ Auth::user()->name }} (S Provider)</a>
                                    <ul class="drop-down one-column hover-fade">
                            ...
                            @else
                                <li class="login-form"> <a href="#" title="Register">Hi, {{ Auth::user()->name }} (Customer)</a>
                                    <ul class="drop-down one-column hover-fade">
